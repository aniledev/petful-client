...
<h3 align="center">A First In First Out Pet Adoption Service</h3>

<p align="center">
<img alt="GitHub language count" src="https://img.shields.io/github/languages/count/aniledev/petful-client">
...
This full stack pet adoption application relies on the use of a [queue data strucutre](https://www.geeksforgeeks.org/queue-data-structure) as well as the following languages and frameworks:
...
## Deployment
- Client deployed with [Vercel](https://petful-omega.vercel.app/)
- Server deployed with [Heroku](https://fifo-pet-server.herokuapp.com)
- You can view the source code for the server and database at this [repo](https://github.com/aniledev/petful-server).
